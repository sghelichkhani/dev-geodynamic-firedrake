...
import scipy.special, math, get_gplates_velocities, numpy
...
for timestep in range(0, max_timesteps):
    ...
    # Only set those ones that are at the surface >= rmin
    get_gplates_velocities.gplates_interpolator.set_time(time)
    gplates_velocities.dat.data_with_halos[bc_gplates.nodes] = get_gplates_velocities.gplates_interpolator.get_velocities(boundary_X)
