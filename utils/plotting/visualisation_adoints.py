...
type_simu =  'rectangle_Q2'
case = 'BFGS_linesearchCubic_wPlates'

opt_file_path = '/home/sia/Workplace/dev-geodynamic-firedrake/adjoint_tic/'+type_simu+'/cases/'+case+'/visual/opt_file.pvd'
output_path = './PNGs/rectangle_extruded_Q2/'+case+'/'


# create a new 'PVD Reader'
opt_filepvd = PVDReader(registrationName='opt_file.pvd', FileName=opt_file_path)

if not os.path.isfile(opt_file_path):
    raise ValueError(opt_file_path)
...
initTemperatureLUT.RescaleTransferFunction(0.25, 0.55)

# Rescale transfer function
initTemperaturePWF.RescaleTransferFunction(0.25, 0.55)
...
# Rescale transfer function
finTemperatureLUT.RescaleTransferFunction(0.25, 0.55)

# Rescale transfer function
finTemperaturePWF.RescaleTransferFunction(0.25, 0.55)
