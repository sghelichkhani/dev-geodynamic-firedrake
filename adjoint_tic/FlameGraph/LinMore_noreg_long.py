...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        self.opt_t_final_file    = File('visual_long/opt_temperature_fin.pvd')
        self.opt_t_init_file     = File('visual_long/opt_temperature_int.pvd')
        ...
        true_initial_state_file = DumbCheckpoint("../../forward/State_20", mode=FILE_READ)
...
with stop_annotating():
    ...
    ckpt_T_ic = DumbCheckpoint("T_ic_optimal_long",\
