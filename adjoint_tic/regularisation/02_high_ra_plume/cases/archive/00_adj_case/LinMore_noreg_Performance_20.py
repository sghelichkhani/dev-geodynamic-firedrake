...
final_state_file = DumbCheckpoint("../../forward/State_060", mode=FILE_READ)
...
u_, p_    = z.split() # Do this first to extract individual velocity, pressure and lagrange multplier fields:
u_.rename('Velocity') 
p_.rename('Pressure')
...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        true_initial_state_file = DumbCheckpoint("../../forward/State_000" , mode=FILE_READ)
