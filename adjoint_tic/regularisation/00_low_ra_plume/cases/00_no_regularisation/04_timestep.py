...
reduced_functional = myReducedFunctional(temp_functional+0.01*u_functional, control)
...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        self.opt_t_final_file = File('visual_freeslip/opt_temperature_fin.pvd')
        self.opt_t_init_file = File('visual_freeslip/opt_temperature_int.pvd')
