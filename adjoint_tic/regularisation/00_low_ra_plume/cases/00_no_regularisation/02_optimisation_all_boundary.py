...
bcu_topleftright = DirichletBC(Z.sub(0), u_surface, (top_id, left_id, right_id))
all_u_bounds = [bcu_base, bcu_topleftright]
...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        self.opt_t_final_file = File('visual_all/opt_temperature_fin.pvd')
        self.opt_t_init_file = File('visual_all/opt_temperature_int.pvd')

        self.solution_checkpoint = CheckpointFile("solution.h5", mode="w")
