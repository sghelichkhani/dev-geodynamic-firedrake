...
final_state_file = DumbCheckpoint(str("../../forward/State_%3.3i" %(max_num_timesteps)), mode=FILE_READ)
...
for timestep in range(18, max_num_timesteps):
...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        true_initial_state_file = DumbCheckpoint(("../../forward/State_%3.3i" %max_num_timesteps), mode=FILE_READ)
