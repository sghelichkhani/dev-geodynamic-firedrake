...
bcu_all = DirichletBC(Z.sub(0), u_surface, (top_id, left_id, right_id, bottom_id))
all_u_bounds = [bcu_all]
...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        self.opt_t_final_file = File('visual_18_imposed_all/opt_temperature_fin.pvd')
        self.opt_t_init_file = File('visual_18_imposed_all/opt_temperature_int.pvd')

        self.solution_checkpoint = CheckpointFile("solution_18_imposed_all.h5",
                                                  mode="w"
                                                  )
