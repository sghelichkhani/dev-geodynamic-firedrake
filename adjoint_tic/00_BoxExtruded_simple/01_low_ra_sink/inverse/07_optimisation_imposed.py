...
reduced_functional = myReducedFunctional(functional, control, fname="visual_07_imposed/objective.pvd")
...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        self.opt_t_final_file = File('visual_07_imposed/opt_temperature_fin.pvd')
        self.opt_t_init_file = File('visual_07_imposed/opt_temperature_int.pvd')

        self.solution_checkpoint = CheckpointFile("solution_07_imposed.h5",
                                                  mode="w"
                                                  )
