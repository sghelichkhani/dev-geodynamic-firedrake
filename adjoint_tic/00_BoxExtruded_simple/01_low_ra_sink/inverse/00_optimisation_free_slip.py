...
class myStatusTest(ROL.StatusTest):
    def __init__(self, params, vector):
        ...
        self.opt_t_final_file = File('visual_00_fslip/opt_temperature_fin.pvd')
        self.opt_t_init_file = File('visual_00_fslip/opt_temperature_int.pvd')

        self.solution_checkpoint = CheckpointFile("solution_00_fslip.h5", mode="w")
