...
log("Printing:", steps[abs(indices - T_ic_idx).argmin()])
...
p._name = 'Pressure'
u_file     = File('01_reference_forward/velocity.pvd')
p_file     = File('01_reference_forward/pressure.pvd')
t_file     = File('01_reference_forward/temperature.pvd')
mu_file    = File('01_reference_forward/viscosity.pvd')
