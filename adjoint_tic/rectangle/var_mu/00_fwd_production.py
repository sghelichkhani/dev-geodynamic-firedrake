...
u_file = File('ouputs/FWDREFmodel/velocity.pvd')
p_file = File('ouputs/FWDREFmodel/pressure.pvd')
t_file = File('ouputs/FWDREFmodel/temperature.pvd')
