...
# Stokes
stokes_prob     = vs.NonlinearVariationalProblem(F_stokes, z, bcs=[bcu_top, bcu_base, bcu_rightleft])
...
class OptimisationOutputCallbackPost:
    def __init__(self):
        self.iter_idx = 0
        self.opt_file             = File('./outputs/04_Reconstruction_IMPOSED/opt_file.pvd') 
