...
case = 'SteepestDescent_Backtracking_StrongWolf'

output_path = './PNGs/'+case+'/'
# create a new 'PVD Reader'
opt_filepvd = PVDReader(registrationName='opt_file.pvd', FileName='/Users/sghelichkhani/Data/cosgrove/Workplace/dev-geodynamic-firedrake/adjoint_tic/rectangle/cases/'+case+'/visual/opt_file.pvd')
...
initTemperatureLUT.RescaleTransferFunction(0.0, 1.0)

# Rescale transfer function
initTemperaturePWF.RescaleTransferFunction(0.0, 1.0)
...
# Rescale transfer function
finTemperatureLUT.RescaleTransferFunction(0.0, 1.0)

# Rescale transfer function
finTemperaturePWF.RescaleTransferFunction(0.0, 1.0)
