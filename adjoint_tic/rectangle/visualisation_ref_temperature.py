...
temperaturepvd = PVDReader(registrationName='temperature.pvd', FileName='/Users/sghelichkhani/Data/cosgrove/Workplace/dev-geodynamic-firedrake/adjoint_tic/rectangle/FWDREFmodel/temperature.pvd')
...
viscosityLUT.RescaleTransferFunction(0.0, 1.0)

# Rescale transfer function
viscosityPWF.RescaleTransferFunction(0.0, 1.0)
