...
temperaturepvd = PVDReader(registrationName='temperature.pvd', FileName='/home/sia/Workplace/dev-geodynamic-firedrake/adjoint_tic/rectangle_high_Ra/Visual/temperature.pvd')
...
viscosityLUT.RescaleTransferFunction(0.35, 0.55)

# Rescale transfer function
viscosityPWF.RescaleTransferFunction(0.35, 0.55)

# Properties modified on viscosityLUT
viscosityLUT.NumberOfTableValues = 20
