...
bcu_top     = DirichletBC(Z.sub(0), u_top, (top_id)) # top boundary will be imposed 
...
stokes_problem = LinearVariationalProblem(a, L, z, constant_jacobian=True, bcs=[bcu_top, bcu_base, bcu_rightleft])
