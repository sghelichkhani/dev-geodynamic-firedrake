...
# Loading in from the diffused state
T_ic_data = DumbCheckpoint("diffused", single_file=True, mode=FILE_READ, comm=mesh.comm)
T_ic_data.load(T_old, name='Temperature')
T_ic_data.close()
