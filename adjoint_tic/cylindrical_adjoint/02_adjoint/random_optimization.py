...
exit()
# seeing about the gradient
res = reduced_functional(T_ic)
gradient = reduced_functional.derivative(T_ic)


my_norm = assemble(gradient * dx)

gradient = assemble((1/my_norm)*gradient)

### Write optimal initial condition
gradient_file = File('second_gradient.pvd')
